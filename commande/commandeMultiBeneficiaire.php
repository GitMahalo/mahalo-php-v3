...
////////////////////////////////////////////////////////////////////
	...
	//$clientPP1["codeTiers"] = XXXX; //code du tiers précédement créé ou identifié, obligatoire si type client = 2
	...
	//$clientPP2["codeTiers"] = XXXX; //code du tiers précédement créé ou identifié, obligatoire si type client = 2
	...
	$commandeDuclient["nePasModifierClient"] = 1; //si 0 il faut envoyer tous les éléments d'adresses, si 1 -> les éléments d'adresses sont optionnels
	...
	//$ligneCommande0["codeClientLiv"] = XXXX; //codeClient du bénéficiaire 1
	...
	//$ligneCommande1["codeClientLiv"] = XXXX; //codeClient du bénéficiaire 2
