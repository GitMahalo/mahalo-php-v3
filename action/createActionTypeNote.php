<?php
	...
	$newAction["type"] = "Notes"; //Valeur possible : Courrier / Email / Tel / SMS / Notes / Ticket / Pige
	$newAction["object"] = "Une note"; //Objet de l'action
	...
	$newAction["texte"] = "Texte de la note pour la nouvelle action";
